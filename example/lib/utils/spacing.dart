...
class Spacing {
  static const SizedBox verticalSpaceX = SizedBox(height: 10);
  static const SizedBox verticalSpaceXV = SizedBox(height: 15);
  static const SizedBox verticalSpaceXX = SizedBox(height: 20);
